        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, defaultValue: "Hello"),
                    ...
                    ShippingWeight = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavouriteProductId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_FavouriteProducts_FavouriteProductId",
                        column: x => x.FavouriteProductId,
                        principalTable: "FavouriteProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavouriteItems_FavouriteProducts_FavoriteProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_FavouriteProductId",
                table: "Users",
                column: "FavouriteProductId",
                unique: true,
                filter: "[FavouriteProductId] IS NOT NULL");
